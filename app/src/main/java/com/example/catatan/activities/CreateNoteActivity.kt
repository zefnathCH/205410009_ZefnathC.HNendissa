package com.example.catatan.activities
...
class CreateNoteActivity : AppCompatActivity() {
    ...
    //proses memunculkan dialog penghapusan
    private fun showDeleteDialog() {
        ...
        dialog.tvHapusCatatan.setOnClickListener {
            //jika user klik ya, maka perintah akan di eksekusi
            // dan akan menghapus data catatan yang ada pada NoteDatabase.
        ...
        //jika user menekan batal, maka proses pembatalan terjadi pada sintax dibawah ini
    ...
    //memunculkan dialog masukan alamat url
